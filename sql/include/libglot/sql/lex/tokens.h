...
enum class TokenType : uint16_t {
    ...
    IF_KW,
    NOT_KW,
    EXISTS_KW, // EXISTS_KW to avoid conflict
    RENAME,
    ADD,
    MODIFY,
    CHANGE,
    ...
    PREDICT,
    EVALUATE,
    TRAINING_INFO, // BigQuery ML keywords
    ...
    FUNCTION,
    PROCEDURE_KW, // PROCEDURE_KW to distinguish from PROCEDURE already defined
    CALL,
    RETURN_KW,
    RETURNS,
    SETOF, // RETURN_KW for RETURN statement, RETURNS for function return type, SETOF for
    ...
    HASH,
    RANGE_KW,
    LIST_KW, // RANGE_KW and LIST_KW to avoid conflicts
    MAXVALUE,
    MINVALUE,
    ...
    FORCE,
    IGNORE_MYSQL,
    USE_INDEX, // IGNORE_MYSQL to avoid conflict
    LOCAL,
    NO_WRITE_TO_BINLOG, // ANALYZE options

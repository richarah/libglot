...
enum class SQLTokenType : uint16_t {
    ...
    INTERSECT,
    EXCEPT,
    MINUS_KW, // MINUS_KW to avoid conflict with MINUS operator
    AS,
    DISTINCT,
    ALL,
    ANY,
    ...
    IF_KW,
    NOT_KW,
    EXISTS_KW, // _KW suffix to avoid conflicts
    RENAME,
    ADD,
    MODIFY,
    CHANGE,
    ...
    VARCHAR,
    TEXT,
    STRING_TYPE, // STRING_TYPE to avoid conflict with STRING literal
    BOOLEAN,
    BOOL,
    DATE,
    TIME,
    ...
    NOWAIT,
    SKIP,
    LOCKED, // UPDATE_LOCK to avoid conflict
    ...
    STRUCT_KW,
    EXCLUDE,
    REPLACE_DDB, // REPLACE_DDB to avoid conflict with REPLACE_KW
    COLUMNS,
    SAMPLE,
    SUMMARIZE,
    ...
    HASH,
    RANGE_KW,
    LIST_KW, // _KW to avoid conflicts
    MAXVALUE,
    MINVALUE,
...
[[nodiscard]] constexpr std::string_view token_type_name(SQLTokenType type) noexcept {
    switch (type) {
    case SQLTokenType::ERROR:
        return "ERROR";
    case SQLTokenType::EOF_TOKEN:
        return "EOF";
    ...
    case SQLTokenType::PARAMETER:
        return "PARAMETER";
    case SQLTokenType::BIT_STRING:
        return "BIT_STRING";
    case SQLTokenType::HEX_STRING:
        return "HEX_STRING";
    case SQLTokenType::NATIONAL_STRING:
        return "NATIONAL_STRING";

    case SQLTokenType::PLUS:
        return "PLUS";
    case SQLTokenType::MINUS:
        return "MINUS";
    case SQLTokenType::STAR:
        return "STAR";
    case SQLTokenType::SLASH:
        return "SLASH";
    case SQLTokenType::PERCENT:
        return "PERCENT";
    case SQLTokenType::CARET:
        return "CARET";
    case SQLTokenType::AMPERSAND:
        return "AMPERSAND";
    case SQLTokenType::PIPE:
        return "PIPE";
    case SQLTokenType::TILDE:
        return "TILDE";
    case SQLTokenType::EQ:
        return "EQ";
    case SQLTokenType::NEQ:
        return "NEQ";
    case SQLTokenType::LT:
        return "LT";
    case SQLTokenType::LTE:
        return "LTE";
    case SQLTokenType::GT:
        return "GT";
    case SQLTokenType::GTE:
        return "GTE";
    case SQLTokenType::CONCAT:
        return "CONCAT";
    case SQLTokenType::ARROW:
        return "ARROW";
    case SQLTokenType::LONG_ARROW:
        return "LONG_ARROW";
    case SQLTokenType::HASH_ARROW:
        return "HASH_ARROW";
    case SQLTokenType::HASH_LONG_ARROW:
        return "HASH_LONG_ARROW";
    case SQLTokenType::AT_GT:
        return "AT_GT";
    case SQLTokenType::LT_AT:
        return "LT_AT";
    case SQLTokenType::QUESTION:
        return "QUESTION";
    case SQLTokenType::DOUBLE_COLON:
        return "DOUBLE_COLON";
    case SQLTokenType::NULL_SAFE_EQ:
        return "NULL_SAFE_EQ";
    case SQLTokenType::COLON_EQUALS:
        return "COLON_EQUALS";

    case SQLTokenType::LPAREN:
        return "LPAREN";
    case SQLTokenType::RPAREN:
        return "RPAREN";
    case SQLTokenType::LBRACKET:
        return "LBRACKET";
    case SQLTokenType::RBRACKET:
        return "RBRACKET";
    case SQLTokenType::LBRACE:
        return "LBRACE";
    case SQLTokenType::RBRACE:
        return "RBRACE";
    ...
    case SQLTokenType::DELETE:
        return "DELETE";
    case SQLTokenType::MERGE:
        return "MERGE";
    case SQLTokenType::FROM:
        return "FROM";
    case SQLTokenType::WHERE:
        return "WHERE";
    case SQLTokenType::HAVING:
        return "HAVING";
    case SQLTokenType::GROUP:
        return "GROUP";
    case SQLTokenType::ORDER:
        return "ORDER";
    case SQLTokenType::LIMIT:
        return "LIMIT";
    case SQLTokenType::OFFSET:
        return "OFFSET";
    ...
    case SQLTokenType::RIGHT:
        return "RIGHT";
    case SQLTokenType::FULL:
        return "FULL";
    case SQLTokenType::CROSS:
        return "CROSS";
    case SQLTokenType::OUTER:
        return "OUTER";
    case SQLTokenType::ON:
        return "ON";
    case SQLTokenType::USING:
        return "USING";
    case SQLTokenType::NATURAL:
        return "NATURAL";
    case SQLTokenType::UNION:
        return "UNION";
    case SQLTokenType::INTERSECT:
        return "INTERSECT";
    case SQLTokenType::EXCEPT:
        return "EXCEPT";
    case SQLTokenType::MINUS_KW:
        return "MINUS";
    case SQLTokenType::AS:
        return "AS";
    case SQLTokenType::DISTINCT:
        return "DISTINCT";
    case SQLTokenType::ALL:
        return "ALL";
    case SQLTokenType::ANY:
        return "ANY";
    case SQLTokenType::SOME:
        return "SOME";
    ...
    case SQLTokenType::LIKE:
        return "LIKE";
    case SQLTokenType::ILIKE:
        return "ILIKE";
    case SQLTokenType::IS:
        return "IS";
    case SQLTokenType::NULL_KW:
        return "NULL";
    ...
    case SQLTokenType::CASE:
        return "CASE";
    case SQLTokenType::WHEN:
        return "WHEN";
    case SQLTokenType::THEN:
        return "THEN";
    case SQLTokenType::ELSE:
        return "ELSE";
    ...
    case SQLTokenType::DESC:
        return "DESC";
    case SQLTokenType::NULLS:
        return "NULLS";
    case SQLTokenType::FIRST:
        return "FIRST";
    case SQLTokenType::LAST:
        return "LAST";
    case SQLTokenType::WITH:
        return "WITH";
    case SQLTokenType::RECURSIVE:
        return "RECURSIVE";
    case SQLTokenType::VALUES:
        return "VALUES";
    case SQLTokenType::DEFAULT:
        return "DEFAULT";
    case SQLTokenType::SET:
        return "SET";
    case SQLTokenType::RETURNING:
        return "RETURNING";
    ...
    case SQLTokenType::VIEW:
        return "VIEW";
    case SQLTokenType::INDEX:
        return "INDEX";
    case SQLTokenType::SCHEMA:
        return "SCHEMA";
    case SQLTokenType::DATABASE:
        return "DATABASE";
    case SQLTokenType::CATALOG:
        return "CATALOG";
    case SQLTokenType::COLUMN:
        return "COLUMN";
    case SQLTokenType::CONSTRAINT:
        return "CONSTRAINT";
    case SQLTokenType::PRIMARY:
        return "PRIMARY";
    case SQLTokenType::FOREIGN:
        return "FOREIGN";
    case SQLTokenType::KEY:
        return "KEY";
    case SQLTokenType::REFERENCES:
        return "REFERENCES";
    case SQLTokenType::UNIQUE:
        return "UNIQUE";
    case SQLTokenType::CHECK:
        return "CHECK";
    case SQLTokenType::DEFAULT_KW:
        return "DEFAULT";
    case SQLTokenType::TEMPORARY:
        return "TEMPORARY";
    case SQLTokenType::TEMP:
        return "TEMP";
    case SQLTokenType::IF_KW:
        return "IF";
    case SQLTokenType::NOT_KW:
        return "NOT";
    case SQLTokenType::EXISTS_KW:
        return "EXISTS";
    case SQLTokenType::RENAME:
        return "RENAME";
    case SQLTokenType::ADD:
        return "ADD";
    case SQLTokenType::MODIFY:
        return "MODIFY";
    case SQLTokenType::CHANGE:
        return "CHANGE";
